...
class RegisterActivity : AppCompatActivity() {
    ...
    // After select image (startActivityForResult) is finished, display changes
...
//            selectPhoto_button_register.setBackgroundDrawable(bitmapDrawable)
    ...
    /**
     * Uploads image to storage when user is created
     */
    ...
    private fun saveUserToFirebaseDatabase(profileImageUrl: String) {
        ...
        ref.setValue(user)
            .addOnSuccessListener {
                ...
                // In case of user going back, it closes the application rather than goes back
                // to register form
